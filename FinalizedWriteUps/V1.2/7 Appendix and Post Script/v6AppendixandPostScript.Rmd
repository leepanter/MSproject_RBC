...
fontsize: 12pt
subtitle: Version 6.0-Appendix and Post-Script
...
```{r, echo=FALSE}
WD="/Users/lee/Documents/GitHub/MSproject_RBC/MSproject_RBC/FinalizedWriteUps/v6/7 Appendix and Post Script"
setwd(WD)
```
<!------------------------------------------------------------------------------>
