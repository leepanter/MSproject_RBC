...
<!--  Working Directory  -->       
```{r, echo=FALSE}
WD="/Users/lee/Documents/Lee/School/CU Denver/MS_Project/Data:Scripts/RBC/Modeling/LMMwREslope"
setwd(WD)
```
...
```{r}
LMMwREslope=lmer(mala~cd19 + (1|subject.no) + (0+cd19|subject.no), dat)
...
cd19Slope=FixedEffects[2]
coefSlp=rep(cd19Slope, times=15)
...
coef.slopes=RandomEffects$subject.no$cd19
...
coef.slopes=RandomEffects$subject.no$logcd19
coefSlp=coefSlp+coef.slopes
...
dat$fit=fitted(logLMMwREslope)
dat$res=residuals(logLMMwREslope)
